    ...
    <section id="content" class="page-content">
        ...
        <form action="{$link->getModuleLink('BulkOrder', 'new')|escape:'html'}" id="submit_parts" class="js-customer-form" method="post">
            <section style="text-transform: capitalize;">
                ...
                <div class="tab">
                  ...
                  <button id="uploadList" class="tablinks" onclick="changeTab(event, 'uploadFileList');" type="button">Upload A File</button>
                </div>

                <!-- Tab Pages -->
                <div id="manualInput" class="tabcontent text-center pb-1" style="display: block;">
                    <div id="inputContainer" class="my-1">
                        <h1 class="h3 d-inline-block">Part Number</h1>
                        <h1 class="h3 d-inline-block">Qty</h1>                    
                        <h1 class="h3 d-inline-block">Part Number</h1>
                        <h1 class="h3 d-inline-block">Qty</h1>
                        <h1 class="h3 d-inline-block">Part Number</h1>
                        <h1 class="h3 d-inline-block">Qty</h1>
                        ...
                        <input class="form-control form-control-md d-inline-block" tabindex="21" type="text" name="partNumbers[]" value="" maxlength="26" size="12">
                        <input class="form-control form-control-md d-inline-block" tabindex="22" type="number" name="partQty[]" value="1" min="1">
                        <input class="form-control form-control-md d-inline-block" tabindex="23" type="text" name="partNumbers[]" value="" maxlength="26" size="12">
                        <input class="form-control form-control-md d-inline-block" tabindex="24" type="number" name="partQty[]" value="1" min="1">
                    </div>
                    <button class="btn btn-primary form-control-submit d-sm-inline" data-link-action="submit_parts" name="submit_parts" type="submit">
                      {l s='Add To List' d='Shop.Theme.Actions'}
                    </button>
                    <button type="button" class="btn btn-primary d-sm-inline" onclick="addPartsRow();">+ Enter More Parts</button>
                    <input type="reset" value="Reset" class="btn btn-primary d-sm-inline">
                </div>

                <div id="textBoxList" class="tabcontent text-center pb-1">
                    <div class="text-sm-left">
                        ...
                        <label for="list_type_1" class="list_type" title="A comma delimited list of part umbers only. In the following format: partNumber1,partNumber2,partNumber3">Parts List Only</label>                    
                ...
                <div id="uploadFileList"  class="tabcontent py-3 px-3">
                    <h3>Please choose a file type and select a file to upload.</h3>
                    <input type='file' id="getFile" style="display:none">
                    <select name="file_type" id="file_type" class="mr-1 my-1 float-sm-left" onchange="fileTypeSelected(this);">
                    ...
                    <button id="choose_file_btn" class="btn btn-primary my-1 float-sm-left" onclick="selectFile(this);" type="button">Select File</button>
                </div>
                <!--/ Tab Pages -->
            </section>
            ...
            <footer class="form-footer clearfix my-1">
              ...
              {block "form_buttons"}
                <button class="btn btn-primary form-control-submit float-xs-left add-to-cart" type="button" onclick="AddItemsToCart(event);">
                  {l s='Add To Cart' d='Shop.Theme.Actions'}
                </button>
                <button class="btn btn-primary form-control-submit add-to-cart float-xs-right" type="button" onclick="ClearList();">
                    {l s='Clear List' d='Shop.Theme.Actions'}
                </button>   
              {/block}
            </footer>
            {/block}
        ...
        <div id="ListContainer">
            ...
            <div class="alert alert-warning" id="noProductsInList">
                {l s='There are no products to display, please enter SKU / MPN values. Then click the add to list button.' mod='BulkOrder'}
            </div>
            {/if}
        </div>
        <div class="clr_hr"></div>
        <div class="clr_10"></div>
        <button class="btn btn-primary form-control-submit add-to-cart" type="button" onclick="AddItemsToCart(event);">
            {l s='Add To Cart' d='Shop.Theme.Actions'}
        </button>    
    </section>
